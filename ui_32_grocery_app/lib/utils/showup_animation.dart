...
class ShowUpAnimation2 extends StatefulWidget {
  /// GETTING THE CHILD WIDGET
  final Widget child;
  /// GETTING THE ANIMATION DURATION
  int? delay;

  ShowUpAnimation2({required this.child,  this.delay});

  @override
  _ShowUpAnimation2State createState() => _ShowUpAnimation2State();
}

class _ShowUpAnimation2State extends State<ShowUpAnimation2> with TickerProviderStateMixin {
  /// CREATING THE ANIMATION CONTROLLER VARIABLE
  late AnimationController _animController;
  /// CREATING THE ANIMATION  VARIABLE OF TYPE OFFSET
  late Animation<Offset> _animOffset;
